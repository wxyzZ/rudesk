...
install -Dm 644 $HBB/res/homedesk.desktop -t "%{buildroot}/usr/share/rustdesk/files"
install -Dm 644 $HBB/res/homedesk-link.desktop -t "%{buildroot}/usr/share/rustdesk/files"
